...
- **Deeper noun coverage** — IN PROGRESS: N5+N6+N7 (2026-06-06) pulled the **1001–2000 frequency tier** (WebFetched from Wiktionary) and added **292 new nouns** into the existing 18 folders → nouns now **667**. **~139 candidates from the 1001–2000 tier remain** for N8+ (a handful are perennial non-nouns like деревянный/бедный that the classifier keeps dropping). Re-derive the still-uncovered list by ё-folded-excluding current `nouns/` labels from the 1001–2000 list (proven recipe — see N5/N6/N7 work-log). Going beyond rank 2000 would need an even deeper frequency source.
