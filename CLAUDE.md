...
- **~100 most common adjectives** — **currently 50** (25 binary pairs: 10 original + 15 added 2026-06-05 Batch 1; all pairs now have ≥10 missions — the five thin 5-mission pairs were topped up). **Owner preference (2026-06-05): favor BINARY antonym pairs wherever applicable** — descriptive adjectives mostly come in opposites (большой/маленький, тёплый/холодный), and teaching them paired reinforces the nature of description. Keep building in the `binary-adjectives/` pair format; only fall back to a standalone adjective lesson when a word has no natural antonym. **Remaining (deferred for staging): ~14 more antonym pairs** (огромный/крошечный already done; still to do e.g. широкий/узкий done — see work log for exactly which 15 landed; the leftover ~14 include глубокий/неглубокий, долгий/краткий, частый/редкий, тихий/громкий, острый/тупой, весёлый/грустный, сухой/мокрый, прямой/кривой, счастливый/несчастный, старший/младший, правый/левый, открытый/закрытый, крупный/мелкий) **+ ~12 standalone adjectives** (главный, русский, colors, etc.),
